...
@Entity
public class LokaliseTranslations extends PanacheEntityBase {
    ...
    public LokaliseTranslations(long translation_id, int key_id, String web_key_name, String lang_iso, String translation,
